...
import 'text_widget/earth_widget.dart';
        ...
        children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Container(
                height: 150,
                width: 150,
                child: Image.asset("assets/earth3.gif"))
          ]),
          Divider(color: Colors.black38),
          Expanded(child: EarthWidget()),
        ],
      ),
    ),
  ),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Container(
                height: 150, width: 150, child: Image.asset("assets/isro.jpg"))
          ]),
          Divider(color: Colors.black38),
          Expanded(child: IndiaWidget()),
        ],
      ),
    ),
  ),
